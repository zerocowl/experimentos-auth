...
import {
  IServiceTaskSearchByUserIdResponse
} from './interfaces/task/service-task-search-by-user-id-response.interface';
...
export class TasksController {
  ...
  public async getTasks(
    ...
    const tasksResponse: IServiceTaskSearchByUserIdResponse = await this.taskServiceClient.send(
  ...
  public async createTask(
    ...
    const userInfo = request.user;
    const createTaskResponse: IServiceTaskCreateResponse = await this.taskServiceClient.send(
      'task_create',
  ...
  public async deleteTask(
    ...
    const deleteTaskResponse: IServiceTaskDeleteResponse = await this.taskServiceClient.send(
      'task_delete_by_id',
      {
        id: params.id,
        userId: userInfo.id
  ...
  public async updateTask(
    ...
    const userInfo = request.user;
    const updateTaskResponse: IServiceTaskUpdateByIdResponse = await this.taskServiceClient.send(
      'task_update_by_id',
      {
        id: params.id,
        userId: userInfo.id,
